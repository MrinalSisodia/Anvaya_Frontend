...
## Setting Charts with data & labels
```jsx
...
```jsx
  ...
  return (
    <>
      ...
      <main className="d-flex bg-light" style={{ height: "calc(100vh - 56px)" }}>
        {/* Sidebar */}
          ...
          <div className="container">
            ...
            >
              <div style={{ maxWidth: "280px" }}>
                <h5 className="mb-1">Closed vs Pipeline</h5>
